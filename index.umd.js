const bs4ModalMvc = {
    ...
    showPostbackModal(options) {
        ...
        modal.find(".modal-body").load(options.ajaxUrl, function () {
            bs4ModalMvc.setAjaxSubmit($(this), function () {    // set formNullCallback func
    ...
    setAjaxSubmit(target, formNullCallback) {
        ...
        form.on('submit', function (e) {
            ...
            xhr.done(function () {
                bs4ModalMvc.setAjaxSubmit(target, formNullCallback);
            });
        });
    },
    ...
    handleDataModalCreate() {
        $("[data-modal-create]").click(function () {
            ...
            bs4ModalMvc.showPostbackModal(options);
        });
    },
